...
# Ak Power X Bot
**Ak Power X Bot** is a _multipurpose_ Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive.
[Supported Groups](https://www.atozcartoonist.com/)
# Features supported:
## Additional Features
...
Thanks to:
- [AtoZ Cartoonist (Akash)](https://www.atozcartoonist.com/) for original repo
